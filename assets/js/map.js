...
const map = new google.maps.Map(document.getElementById("map"), {
  ...
  const customIcons = {
   ...
   // List of all marker coordinates inserted on the map 
      const myCoordinates = [
          {"address": "Address:<br> Earlsfort Terrace,<br> Dublin 2.", "website": "https://www.nch.ie/Online/default.asp", "name": "National Concert Hall", "lat": 53.334653, "lng": -6.258785, "information": `NCH is Ireland's primary
          ...
          {"address": "Address:<br> 58 Thomas Street,<br>Dublin 8.", "website": "https://www.vicarstreet.com/", "name": "Vicar Street", "lat": 53.342609,"lng": -6.277989, "information": `Vicar Street has, for well over 30 years,
          ...
          {"address": "Address:<br>57 Middle Abbey Street,<br> Dublin 8.", "website": "https://www.theacademydublin.com/", "name": "Academy", "lat": 53.348034, "lng": -6.262003, "information": `A relatively new venue on the Dublin scene, The Academy
          ...
          {"address": "Address:<br> 28 Thomas Street,<br> Dublin 8.", "website": "https://www.arthurspub.ie/", "name": "Arthurs", "lat": 53.343167, "lng": -6.28168, "information": `Arthurs is Dublin's go to spot for Jazz & Blues in the capital.
          ...
          {"address": "3 Arena,<br> North Wall Quay,<br> Dublin 1.", "website": "https://www.3arena.ie/", "name": "3Arena", "lat": 53.347496, "lng": -6.228508, "information": `The 3Arena is Irelands largest venue and go to spot for the world's biggest
          ...
          {"address": "Address:<br> Newtown Park Avenue<br> Blackrock<br> Co. Dublin", "website": "https://www.newparkmusic.ie/","name": "Newpark/Rock Jam", "lat": 53.289883, "lng": -6.171961, "information": `Newpark Music Centre is an internationally recognised
          ...
          {"address": "Address:<br> Belfield Campus,<br> Dublin 4.", "website": "https://www.ucd.ie/music/", "name": "UCD", "lat": 53.294747, "lng": -6.184702, "information": `The course at UCD provides an in-depth study into
          ...
          {"address": "Address:<br> 79 Francis Street,<br> Dublin 7.", "website": "https://www.bimm.ie/", "name": "BIMM", "lat": 53.339906, "lng": -6.273719, "information": `The Irish branch of BIMM opened in 2012 and has become renowned
          ...
          {"address": "Address:<br>Dublin Road,<br> Kilbarack Lower,<br> Dublin 13.","website": "http://www.rockschool.ie/", "name": "Rock School", "lat": 53.385592, "lng": -6.140353, "information": `Frank Kearns Rock School offers lessons to all ages and
          ...
          {"address": "Address:<br> Red Cow Retail Center,<br>Ballymount,<br>Dublin 22.", "website": "https://www.xmusic.ie/", "name": "XMusic", "lat": 53.317752, "lng": -6.360684, "information": `XMusic is a music superstore stocking everything from drums
          ...
          {"address": "Address:<br> 29 Exchequer Street,<br>Dublin 2.", "website": "https://www.musicmaker.ie/", "name": "Music Maker", "lat": 53.343126, "lng": -6.262568, "information": `Music Maker is Ireland's longest running general
          ...
          {"address": "Address<br> Waltons Blanchardstown,<br> Blanchardstown Center.", "website": "https://www.waltons.ie/", "name": "Waltons", "lat": 53.394871, "lng": -6.394655, "information":  `Waltons is a long established family business offering quality
          ...
          {"address": "Address:<br> 134 Capel Street,<br> Dublin 1.", "website": "https://www.goodwinsmusic.ie/", "name": "Goodwins", "lat": 53.348098, "lng": -6.268734, 
          ...
          {"address": "Address:<br> Unit 137,<br> Baldoyle Industrial Estate,<br> Baldoyle,<br> Dublin 13.", "website": "https://www.mcneelamusic.com/", "name": "McNeela", "lat": 53.394518, "lng": -6.145391, "information": `McNeela Irish Music Instruments is a recently 
  ...
  // var website = "https://www.google.com"
    ...
    for (let i = 0; i < myCoordinates.length; i++) {
        const contentString = '<h3 class="info-window-header">' + myCoordinates[i].name + '</h3>' + 
                         '<p class="info-window-p">' + myCoordinates[i].information + '</p>' +
                         '<p class="info-window-p">' + myCoordinates[i].address + '</p>' +
        '<a class="info-window-a" href="' + myCoordinates[i].website + '"target=_blank>Website</a>';                    ; 
